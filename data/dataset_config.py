...
class FlirAlignedCfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='train_sub/images_thermal_train_train_night/night_flir.json', img_dir='train_sub/images_thermal_train_train_night/data/', has_labels=True),
        val=dict(ann_filename='train_sub/images_thermal_train_val_night/night_flir.json', img_dir='train_sub/images_thermal_train_val_night/data/', has_labels=True),
